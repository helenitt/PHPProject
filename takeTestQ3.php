  ...
  <body onload="var changeImages=setInterval('homes()',2000);">
   ...
   <!--    <br><br>
    ...
    <div id="content">
      ...
      <form name="taketest" method="post" action="testResults.php">    
        <fieldset>          

<?php

if($_POST['question3'] == "Next Question")  
{
...
//GET QUESTION
$sqlgetquest = "SELECT * FROM quests WHERE qid = $rand3";
...
?>
            ...
            <input type="radio" name="Q3" value="<?php echo $row['a1']; ?>">&nbsp;&nbsp;  
            <label><?php echo $row['a1']; ?></label><br>
            
            <input type="radio" name="Q3" value="<?php echo $row['a2']; ?>">&nbsp;&nbsp;  
            <label><?php echo $row['a2']; ?></label><br>
            
            <input type="radio" name="Q3" value="<?php echo $row['a3']; ?>">&nbsp;&nbsp;  
            ...
            <input type="text" name="qid" value="<?php echo $rand3; ?>" hidden="" >&nbsp;&nbsp;
            <input type="text" name="score" value="<?php echo $score; ?>" hidden="" >
            <br>
            
            <input type="submit" name="submittest" value="Submit Test" />
